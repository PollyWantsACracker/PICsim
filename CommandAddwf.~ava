public class CommandAddwf extends Command {
  ...
  public CommandAddwf (int aProgrammCounterLine, int aParameter1, int aParameter2, int aMachineCycles, DataStorage aDataStorage, WRegister aWRegister) {
  ...
  public int executeCommand() {
    ...
    int newIndirectValue = actualValue + dataStorage.getValue(getBankOffset() + 4);
    int newDirectValue = actualValue + dataStorage.getValue(getBankOffset() + parameter1);
