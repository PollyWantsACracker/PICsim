...
public class CommandMovf extends Command {
    ...
    public CommandMovf (int aLineNumber, WReg aWReg, DataStorage aStack) {
        super (aLineNumber,1);
        this.wReg = aWReg;
    ...
    public int executeCommand() {
        ...
        if (parameters[1] == 0){
            wReg.setValue(parameters[0]);
        } else {
            dataStorage.setValue(parameters[0], dataStorage.getValue(parameters[0]));
        }
        return -1;
    }
}
